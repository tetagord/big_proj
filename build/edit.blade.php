...
@section('content')
    <div class="cv-fon"><img src="https://via.placeholder.com/1920x400" alt=""></div>
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-6 cv-left"><img class="cv-avatar" src="https://via.placeholder.com/300x300"
                                                      alt="">
                            ...
                            <div class="cv-content experience-item">
                                ...
                                <div class="cv-periods flex flex-wrap">
                                    ...
                                    <div class="cv-radio flex flex-column">
                                        ...
                                        <div class="filter-by flex"><span class="filter-by--title">Нет</span>
                        ...
                        <div id="education-place">
                            <div class="education-item">
                                ...
                                <div class="cv-content--line flex justify-content-between align-items-end">
                                    ...
                                    <div class="cv-input cv--part">
                                        <input hidden name="education[file][]"/>
                                        <button class="btn btn--cv">Загрузить диплом</button>
                                    </div>
                                </div>
                                <div class="cv-radio flex flex-wrap">
                                    <p>Еще учусь</p>
                    ...
                    <div class="cv-content">
                        <div id="certificate-place">
                            <div class="certificate-item">
                                ...
                                <button class="btn btn--cv btn--cv-right">Загрузить сертификат</button>
                            </div>
                        </div>
                    </div>
